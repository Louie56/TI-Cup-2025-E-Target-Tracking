...
//    // 等待用户把车放到白色背景上
//    uart0_send_string("请将小车放在白色区域上，3秒后开始采样...\r\n");
//    delay_ms(3000);  // 延时等待准备
//	
//    // 采集白色值
//    for (int j = 0; j < 10; j++)  // 多次采样平均，抗干扰
//    {
//        No_Mcu_Ganv_Sensor_Task_Without_tick(&sensor);
...
//    uart0_send_string("白色采样完成，请将传感器对准黑线，3秒后开始采样黑色值...\r\n");
//    delay_ms(3000);

//    // 采集黑色值
//    for (int j = 0; j < 10; j++)  // 多次采样平均
//    {
//        No_Mcu_Ganv_Sensor_Task_Without_tick(&sensor);
//        for (int i = 0; i < 8; i++)
//        {
...
//    uart0_send_string("黑白自动校准完成！\r\n");
//}
//void Auto_Calibrate(No_MCU_Sensor *sensor_ptr)
//{
//    uart0_send_string("将小车放到白底上，3秒后采集白色值...\r\n");
//    delay_ms(3000);
//	unsigned short white[8];
//	unsigned short black[8];
...
//    uart0_send_string("将黑线放到传感器下方，3秒后采集黑色值...\r\n");
//    delay_ms(3000);
...
//    uart0_send_string("黑白校准完成，开始循迹任务...\r\n");
